(defproject jim-emacs-fun-mxnet "0.1.0-SNAPSHOT"
  ...
  :main ^:skip-aot jim-emacs-fun-mxnet.core
  ...
  {:nrepl {:port 7002}
   ...
   {:app
    {:target :browser
     ...
     :asset-path "/js"
     :modules {:app {:entries [jim-emacs-fun-mxnet.app]}}
     :devtools
  ...
  {:uberjar {:omit-source true
             ...
             :aot :all
             :uberjar-name "jim-emacs-fun-mxnet.jar"
