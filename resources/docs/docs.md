...
The `home-routes` handler in the `jim-emacs-fun-mxnet.routes.home` namespace
...
The `home-page` function will in turn call the `jim-emacs-fun-mxnet.layout/render` function
...
The rest of this page is rendered by ClojureScript found in the `src/cljs/jim_emacs_fun_mxnet/core.cljs` file.



#### Organizing the routes

The routes are aggregated and wrapped with middleware in the `jim-emacs-fun-mxnet.handler` namespace:
...
Request middleware functions are located under the `jim-emacs-fun-mxnet.middleware` namespace.

This namespace is reserved for any custom middleware for the application. Some default middleware is
already defined here. The middleware is assembled in the `wrap-base` function.

Middleware used for development is placed in the `jim-emacs-fun-mxnet.dev-middleware` namespace found in
...
* Let `mount` know to start the database connection by `require`-ing `jim-emacs-fun-mxnet.db.core` in some other namespace.
